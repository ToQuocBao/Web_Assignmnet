...
<body>
  <img id="fixed-background" src="./dell_alienware_m15_r6_background.jpg" alt="fixed-image">
...
<div class="price">
	...
	<div id="menu">
		<ul>
			<li>
				<a href="#">Alienware</a>
				<ul class="sub-menu">
					<li><a href="../DellAlienwareM15R6">Dell Alienware M15 R6</a></li>
				</ul>
			</li>
			<li>
				<a href="#">Inspiron</a>
	...
	<div class="vd">
		<div class="content">
			<div class="cover">
				<h2><strong>Tổng quan về laptop <span>Dell Alienware M15 R6</span></strong></h2>
				<p>Dell vừa cho ra mắt dòng laptop dell alienware một chiếc laptop gaming đầy ấn tượng với hiệu năng khủng đến từ bộ đôi CPU Intel 11th Gen mới nhất và GPU NVIDIA RTX 3000 series mạnh mẽ, tạo nên một sức mạnh hoàn hảo cho các game thủ thoải mái chinh chiến trên các mặt trận game.</p>
			</div>
			<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
			  ...
			  <div class="carousel-inner">
				<div class="carousel-item active">
				  <img src="./dell_alienware_m15_r6_1.jpg" class="d-block w-100" alt="...">
				  <div class="carousel-caption d-none d-md-block">
					<div class="test">
					<h5>Dell alienware M15 R6</h5>
					<p></p>
					</div>
				  </div>
				</div>
				<div class="carousel-item">
				  <img src="./dell_alienware_m15_r6_2.jpg" class="d-block w-100" alt="...">
				  <div class="carousel-caption d-none d-md-block">
					<div class="test">
					<h5>BỘ ĐÔI CHIẾN MÃ CPU INTEL THẾ HỆ 11 VÀ GPU NVIDIA RTX 3000 SERIES </h5>
					<p></p>
					</div>
				  </div>
				</div>
				<div class="carousel-item">
				  <img src="./dell_alienware_m15_r6_3.jpg" class="d-block w-100" alt="...">
				  <div class="carousel-caption d-none d-md-block">
					<div class="test">
					<h5>THIẾT KẾ HẦM HỐ ĐẬM CHẤT GAMING</h5>
					<p></p>
					</div>
				  </div>
				</div>
				<div class="carousel-item">
				  <img src="./dell_alienware_m15_r6_4.jpg" class="d-block w-100" alt="...">

				  <div class="carousel-caption d-none d-md-block">
					<div class="test">
					<h5>MÀN HÌNH SĂC NÉT CHẤT LƯỢNG CAO PHỤC VỤ NHIỀU NHU CẦU SỬ DỤNG KHÁC NHAU</h5>
					<p></p>
					</div>
				  </div>
				</div>
				<div class="carousel-item">
				  <img src="./dell_alienware_m15_r6_5.jpg" class="d-block w-100" alt="...">
				  <div class="carousel-caption d-none d-md-block">
					<div class="test">
					<h5>BÀN PHÍM CÓ HÀNH TRÌNH PHÍM SÂU & TOUCPAD MƯỢT MÀ</h5>
					</div>
				  </div>
				</div>
				<div class="carousel-item">
				  <img src="./dell_alienware_m15_r6_6.jpg" class="d-block w-100" alt="...">
				  <div class="carousel-caption d-none d-md-block">
					<div class="test">
					<h5>CHUẨN WIFI KẾT NỐI NHANH & HỆ THỐNG ÂM THANH SỐNG ĐỘNG </h5>
=					</div>
				  </div>
				</div>
				<div class="carousel-item">
				  <img src="./dell_alienware_m15_r6_7.jpg" class="d-block w-100" alt="...">
				  <div class="carousel-caption d-none d-md-block">
					<div class="test">
					<h5>THỜI LƯỢNG PIN KHÁ ỔN CÓ THỂ ĐẢM BẢO CÔNG VIỆC KHÔNG BỊ GIÁN ĐOẠN</h5>
=					</div>
				  </div>
				</div>
				<div class="carousel-item">
				  <img src="./dell_alienware_m15_r6_8.jpg" class="d-block w-100" alt="...">
				  <div class="carousel-caption d-none d-md-block">
					<div class="test">
					<h5>HỆ THỐNG TẢN NHIỆT KHÁ TỐT GIỮ ĐƯỢC MỨC NHIỆT ĐỘ LÝ TƯỞNG CHO MÁY</h5>
=					</div>
				  </div>
				</div>
			  </div>
			...
			<div class="os">
				...
				<ul>
					<li>Thiết kế hầm hố, chắc chắn đầy bền bỉ, đậm chất gaming.</li>
					<li>Hiệu năng đầy mạnh mẽ với bộ vi xử lý intel mới nhất cùng Rtx 3000 series.</li>
					<li>Thiết kế cổng kết nối khá tính tế tăng thêm không gian cho game thủ sử dụng chuột.</li>
				</ul>
			</div>
			<div class="cost">
				<h2>Giá bán</h2>
				<div class="grid">
					<figure class="effect-ming">
						<img src="./dell_alienware_m15_r6_cost.jpg"/>
						<figcaption>
							<h2><strong>69.000.000 đ</strong></h2>
					...
					<figure class="effect-ming">
						<img src="./dell_alienware_m15_r6_cost2.jpg"/>
						<figcaption>
